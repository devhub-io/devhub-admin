<template>
  <div class="app-container">
    ...
    <el-table v-loading="tableLoading" ref="multipleTable" :data="orderList" stripe style="width: 100%" @select="handleSelect" @select-all="handleSelectAll">
      <el-table-column prop="title" label="id" width="100" />
      <el-table-column prop="slug" label="Spider Name" width="130" />
      <el-table-column prop="homepage" label="Last Runtime" min-width="100"/>
      <el-table-column prop="github" label="Avg Runtime" align="center" width="100" />
    </el-table>

    <el-row>
      <el-col :span="24">
        <el-form ref="form" :model="searchFrom" label-width="80px">
          <el-form-item label="Upload EGG file">
            <el-input v-model="searchFrom.contact_name"/>
            <p>Use scrapyd-client to generate egg file scrapyd-deploy --build-egg output.egg</p>
          </el-form-item>
          <el-form-item>
            <el-button type="primary" @click="batchCheck">Submit</el-button>
          </el-form-item>
        </el-form>
      </el-col>
    </el-row>
